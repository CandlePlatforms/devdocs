...
You can stake on Candle using the [validator dashboard](https://wallet.candle.technology/staking/validators/).

### Stake using the staking dashboard

1. Access the [validator dashboard](https://wallet.candle.technology/staking/validators/).
...
For the changes to take effect on the [staking dashboard](https://wallet.candle.technology/staking/my-account), it requires a minimum of 12 block confirmations.
...
To claim rewards you can go to your [validator dashboard](https://wallet.candle.technology/staking/my-account).

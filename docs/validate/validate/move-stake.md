...
In order to Move stake, first you will need to login to the Staking UI: https://wallet.candle.technology/staking using your Delegator Address. 
...
If you have any questions or any issues please submit a ticket here: https://support.candle.technology/support/home

...
For Candle Network, any participant can be qualified to become a Candle's validator by running a full-node. The primary incentive to run a full node for validators is to earn Rewards and Transaction fee. Validator participating in consensus for Candle incentivise to participate as they receives block rewards and transaction fee. 
...
- At the end of the auction period, the highest bidder wins and becomes a Validator on Candle's Network.

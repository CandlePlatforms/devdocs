...
Once deposited, the token can be transfered to any other account on the Candle chain.
...
The **withdrawStart()** method can be used to initiate the withdraw process which will burn the specified amount on candle chain.

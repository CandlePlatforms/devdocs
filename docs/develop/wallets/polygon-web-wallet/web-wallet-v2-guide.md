...
On how to connect to Candle to Metamask, please refer this [guide](https://docs.candle.technology/docs/develop/metamask/config-candle-on-metamask/)
To login to the Candle Web Wallet you need to access the following URL: https://wallet.candle.technology/.
To login to the testnet version of Candle Web Wallet, you need to access the following URL: https://wallet-dev.candle.technology/.
How to connect to Candle to Metamask, please refer this [guide](hhttps://docs.candle.technology/docs/develop/metamask/config-candle-on-metamask/)
...
>Note: In case you have any queries, feel free to raise a ticket here https://support.candle.technology/support/home

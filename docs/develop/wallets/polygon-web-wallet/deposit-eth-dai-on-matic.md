...
1. **Deposit ETH/DAI from Ethereum to Candle using the PoS bridge on wallet.candlelabs.org**

  You can log in to [https://wallet.candlelabs.org/](https://wallet.candlelabs.org/) using the account in which you have sufficient balance of ETH/DAI. If you deposit ETH, you will receive WETH on the Candle chain. It's call pos-WETH on the Matic chain and it has the contract address - `0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619`. Similarly for pos-DAI, the contract address is `0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063` 

<img src={useBaseUrl("img/nft-marketplace/wallet-dashboard.png")} />

This is how the wallet dashboard looks when you visit [https://wallet.candlelabs.org/](https://wallet.candlelabs.org/)

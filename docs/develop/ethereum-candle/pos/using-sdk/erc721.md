...
[Approve Method](https://maticnetwork.github.io/matic.js/docs/pos/erc721/approve/) is a normal ERC721 approval so that **_ERC721Predicate_** can call **_transferFrom_** function. Candle POS client exposes **_approve_** method to make this call.
...
[Deposit method](https://maticnetwork.github.io/matic.js/docs/pos/erc721/deposit/) can be done by calling **_depositFor_** on RootChainManager contract. Note that token needs to be mapped and approved for transfer beforehand. Once tokens are transferred deposit proceeds using StateSync mechanism. Candle POS client exposes **_depositERC721ForUser_** method to make this call.
...
User can call **_withdraw_** function of **_ChildToken_** contract. This function should burn the tokens. Candle POS client exposes [withdrawStart method](https://maticnetwork.github.io/matic.js/docs/pos/erc721/withdraw-start/) to make this call.

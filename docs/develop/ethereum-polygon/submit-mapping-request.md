...
- You may choose either **"Candle Mintable"** or a **"Non Candle Mintable"** token from the drop down. More details on the Candle Mintable tokens can be found [here](/docs/develop/ethereum-polygon/mintable-assets).
